                ...
                >
                    ...
                    <div className="row" bis_skin_checked={1}>
                        ...
                        <div className="col-sm-6 hidden-xs" bis_skin_checked={1}>
                            <a
                                onclick="window.open('https://www.onlineflightreservation.com/us/security-metrices-certificate.pdf?v5', 'info', 'toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no,width=900,height=600, screenX=100,screenY=50')"
                                href={""}
                            >
                                <img
                        ...
                        >
                            ...
                            >
                                <object
                                    ...
                                    type="image/svg+xml"
                                    data="//seal.digicert.com/seals/cascade/?tag=7dlUvcGZ&referer=www.onlineflightreservation.com&format=svg&an=min"
                                    role="link"
                                    style={{
                                        textDecoration: "none",
                                        textAlign: "center",
